...
const ExampleActions = () => {
  return /*#__PURE__*/React.createElement("div", {
    ...
    href: "https://mozilla-extensions.github.io/firefox-voice/lexicon.html"
...
const Faq = () => {
  return /*#__PURE__*/React.createElement("div", {
    ...
    class: "faq-section-header"
  }, "Why does Firefox Voice ask for all these permissions?")), /*#__PURE__*/React.createElement("p", null, "Because you can use Firefox Voice to execute a wide variety of commands, it first needs permissions to many of those things on your behalf."), /*#__PURE__*/React.createElement("dl", null, /*#__PURE__*/React.createElement("dt", null, "Access your data for all websites"), /*#__PURE__*/React.createElement("dd", null, "This permission allows you to use Firefox Voice to control websites to do things like scroll, copy and paste, find a tab and more.", /*#__PURE__*/React.createElement("br", null), /*#__PURE__*/React.createElement("br", null), "While this permission would make it ", /*#__PURE__*/React.createElement("em", null, "possible"), " to extract user information from a website, it does not do so. Our", " ", /*#__PURE__*/React.createElement("a", {
    href: "https://mozilla-extensions.github.io/firefox-voice/privacy-policy.html"
  }, "Privacy Policy"), " ", "specifies what information we collect (set during installation or later in the preferences). It does NOT include any browsing or site information."), /*#__PURE__*/React.createElement("dt", null, "Read and modify bookmarks"), /*#__PURE__*/React.createElement("dd", null, "This is used for commands that open, create, and delete bookmarks."), /*#__PURE__*/React.createElement("dt", null, "Read and modify browser settings"), /*#__PURE__*/React.createElement("dd", null, "Used to open your preferred homepage set in the browser setting."), /*#__PURE__*/React.createElement("dt", null, "Get data from the clipboard"), /*#__PURE__*/React.createElement("dd", null, "Used to enable voice control for \"paste\"."), /*#__PURE__*/React.createElement("dt", null, "Input data to the clipboard"), /*#__PURE__*/React.createElement("dd", null, "Used to enable voice commands for \u201Ccopy\u201D such as \"copy link\"."), /*#__PURE__*/React.createElement("dt", null, "Download files and read and modify the browser\u2019s download history"), /*#__PURE__*/React.createElement("dd", null, "Used for commands such as \"save page\" and \"save screenshot\" that download files."), /*#__PURE__*/React.createElement("dt", null, "Read the text of all open tabs"), /*#__PURE__*/React.createElement("dd", null, "Used for the command \"find [query] in page\"."), /*#__PURE__*/React.createElement("dt", null, "Access browsing history"), /*#__PURE__*/React.createElement("dd", null, "Used to determine your preferred music service. E.g., if you visit", /*#__PURE__*/React.createElement("code", null, "spotify.com"), " often/recently, it is presumed to be your preferred service."), /*#__PURE__*/React.createElement("dt", null, "Hide and show browser tabs"), /*#__PURE__*/React.createElement("dd", null, "Firefox Voice executes searches in the background, sometimes taking you directly to search results or cards. We use a \"hidden\" tab to do this, so these automatically-created search tabs do not clutter your normal tab layout."), /*#__PURE__*/React.createElement("dt", null, "Access browser tabs"), /*#__PURE__*/React.createElement("dd", null, "Used for finding and managing your tabs."))), /*#__PURE__*/React.createElement("details", null, /*#__PURE__*/React.createElement("summary", null, /*#__PURE__*/React.createElement("div", {
    class: "faq-section-header"
