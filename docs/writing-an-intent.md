...
**enumerate-phrases:** lists all the matched phrases for the specified intent by using `extension/intents/metadata.js` for finding matches. You can execute this script as:
```js 
