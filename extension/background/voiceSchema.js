...
this.voiceSchema = {
  ...
  properties: {
    ...
    environment: {
      ...
      required: ["build", "partner", "settings", "system"],
      type: "object",
    },
    id: {
      pattern:
    ...
    payload: {
      properties: {
        ...
        deepSpeechServerTime: {
          description:
            "Milliseconds for the DeepSpeech transcription to complete and respond",
        ...
        extensionInstallationChannel: {
          description:
            "Where the user first installed the extension (e.g., internal_beta, external_beta, etc)",
          title: "First install channel",
          type: "string",
        },
        extensionTemporaryInstall: {
          description:
            "When the extension is installed locally for development, this will be true",
        ...
        intentExtensionId: {
          description:
            "If intent was handled by another extension, the id of that extension",
          title: "ID of second extension that handled intent",
          type: "string",
        },
        intentExtensionVersion: {
          description:
            "The self-reported title of an extension that handled the intent",
          title: "Title of second extension",
          type: "string",
        },
        intentExtraData: {
          description:
            "A specific intent can add information here about how it interepreted the command",
          title: "Ad hoc intent-specific data",
          type: "object",
        },
        intentFallback: {
          description:
            "True if we couldn't parse the intent to some exact handler, and just fell back on something generic like search",
        ...
        intentServiceName: {
          description:
            "If an intent used some external service, what service did it choose?",
          title: "What service did the intent handler use?",
          type: "string",
        },
        intentSuccess: {
          description:
            "This is the self-reported success of the intent handler",
          title: "Was the intent action successful?",
          type: "boolean",
        },
        intentTime: {
          description:
            "Milliseconds between getting the utterance and execution the intent",
        ...
        localHour: {
          description:
            "The hour, 0-23, in the local timezone when the action was run",
          title: "Local hour of action",
          type: "integer",
        },
        numberOfOpenTabs: {
          description:
            "A count of the number of tabs in all windows, that are open when the tool is activated",
        ...
        siteCategoryTriggering: {
          description:
            "This only set if the intent dependent on the current tab in some way",
      ...
      required: ["extensionVersion", "extensionTemporaryInstall", "timestamp"],
      type: "object",
    },
    type: {
      enum: ["voice"],
