        ...
        <div className="modal">
          ...
          <div className="modal-content">
            <p>
              ...
              identifying information. Can Firefox Voice store transcripts of
              your voice recordings for research?
            </p>
            <p>
              You’ll always be able to use Firefox Voice, even if you don’t
              allow collection. The microphone is only active when triggered
      ...
      if (permissionError === "Waiting") {
        return (
          <>
            ...
            <p>
              Firefox Voice needs permission to access the microphone in order
